...
const SignUp = () => {
    ...
    return (
        <div className='md:w-2/5 lg:w-2/5 xl:w-2/5'>
            {/* card body */}
            <form className='w-full bg-white overflow-hidden  rounded-lg p-5'>
                ...
                <div className='flex justify-between px-5 pt-8'>
                    ...
                    <button className='py-1 px-4 items-center flex space-x-2 rounded-lg bg-[#C1CF16]'><span>Register</span> <BiLogInCircle /></button>
                </div>
            </form>
